...
public class LightningChannelerContainer extends Container {
    ...
    public LightningChannelerContainer(int windowId, World world, BlockPos pos,
        ...
        super(ExampleContainers.LIGHTNING_CHANNELER_CONTAINER.get(), windowId);
    ...
    public boolean stillValid(PlayerEntity playerIn) {
        return !(playerIn.distanceToSqr((double) this.tileEntity.getBlockPos().getX() + 0.5D,
                (double) this.tileEntity.getBlockPos().getY() + 0.5D,
