...
import com.example.examplemod.block.custom.KaupenAltarBlock;
...
public class KJTeleporter implements ITeleporter {
    ...
    public Entity placeEntity(Entity entity, ServerWorld currentWorld, ServerWorld destinationWorld,
        ...
        if (insideDimension) {
            ...
            if (doSetBlock) {
                destinationWorld.setBlock(destinationPos, ExampleBlocks.KAUPEN_ALTAR.get().defaultBlockState(),3);
            }
        }
