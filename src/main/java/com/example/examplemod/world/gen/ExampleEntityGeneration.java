...
public class ExampleEntityGeneration {
    public static void onEntitySpawn(final BiomeLoadingEvent event) {
        addEntityToAllBiomes(event.getSpawns(), ExampleEntityTypes.BUFF_ZOMBIE.get(), 40, 2, 4);
        addEntityToAllBiomesExceptThese(event, ExampleEntityTypes.PIGEON.get(), 50, 4, 10,
