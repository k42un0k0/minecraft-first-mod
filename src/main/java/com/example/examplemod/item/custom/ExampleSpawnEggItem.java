...
public class ExampleSpawnEggItem extends SpawnEggItem {

    protected static final List<ExampleSpawnEggItem> UNADDED_EGGS = new ArrayList<>();
    private final Lazy<? extends EntityType<?>> entityTypeSupplier;

    public ExampleSpawnEggItem(final RegistryObject<? extends EntityType<?>> entityTypeSupplier,
                               int primaryColorIn, int secondaryColorIn, Item.Properties builder) {
